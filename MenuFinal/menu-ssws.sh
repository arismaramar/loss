...
echo ""
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "       ${BIWhite}XRAY SHADOWSOCK MENU ${NC}"
echo -e ""
echo -e "     ${BICyan}[${BIWhite}1${BICyan}] Create Account XRAY Shadowsock Websocket "
echo -e "     ${BICyan}[${BIWhite}2${BICyan}] Extending Account XRAY Shadowsock Active "
echo -e "     ${BICyan}[${BIWhite}3${BICyan}] Delete Account XRAY Shadowsock Websocket  "
echo -e "     ${BICyan}[${BIWhite}4${BICyan}] Check User Login XRAY Shadowsock     "
echo -e ""
...
00 | 0) clear ; menu ;;
x) exit ;;
*) echo -e "" ; echo "Press any key to back on menu" ; sleep 1 ; menus ;;
esac
